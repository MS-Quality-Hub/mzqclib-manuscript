...
def dedupe(list_of_cvparam_like):
    """
    deduplicate lists of mzqc elements that are derived from cvparam (i.e. they have an accession attribute)
    """
...
def merge_mzqc_files(mzqc_output, mzqc_input, compare, log):
